...
class TextBox:
    ...
    def draw(self, screen):
        beakgraund_rect = pygame.Rect(self.rect.left - 10, self.rect.top - 10, self.rect.width + 20, self.rect.height + 20)
        pygame.draw.rect(screen, (155, 150, 200), beakgraund_rect, border_radius=15)
        pygame.draw.rect(screen, (100, 50, 200), beakgraund_rect.inflate(5, 5), 5, border_radius=15)
